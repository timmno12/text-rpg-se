...
public class data {
    ...
    public static Target[] DATA={
            ...
            new Target("Storage Room","door", "go", "Your sister yells out in protest. Were you gonna leave without her?", 10,false),

            new Target("Storage Room","sister", "talk", "Let's get out of here!", 10,false),
            new Target("Storage Room","", "look", "This is definitely a storage room. Lots of shelves filled with gruesome things you don’t really want to look at closely. The door seems like the only way out.", 10,false),
            new Target("Storage Room","door", "go", "It’s not even locked. You open the door just enough to fit through and leave the room.", 10,true),
            ...
            new Target("Hallway (Basement) II","door ahead", "go", "Even if you could get to the door the huge creepers would make it impossible for you to go through.", 10,false),
            ...
            new Target("Hallway (Basement) II","right door", "go", "You hear the fierce flapping of huge wings above you. When you ignore it and try to push the door open, it doesn't move an inch. Above you, you hear scornful laughter.", 10,false),
            new Target("Hallway (Basement) II","left door", "look", "The cat is gone. The door is free.", 10,false),
            new Target("Hallway (Basement) II","left door", "go", "You are about to push open the door when you are shrouded in a huge shadow. The raven holds itself in the air above you. ~Bring me treasure! Bring me gold!~ he crows. ~And I will help you to pass the right door~ You don't answer, but enter the darkness that extends behind the door.", 10,true),
            new Target("Hallway (Basement) II","door behind", "look", "This is where you came from. Nothing exciting there.", 10,false),
            new Target("Hallway (Basement) II","door behind", "go", "You hear your sister's thin voice: ~I don't think we'll find anything in there, besides, it's dark and I never want to see those cages again!~ You turn back toward the hallway.", 10,false),
            ...
            new Target("Ruins of a crumbled church ","button chapel", /*name2: "chapel",*/ "use", "The button falls down. It echoes unreal loud in the chapel. You bend down and pick up the dirty button. It goes back into your pocket.", 10,false),
            new Target("Ruins of a crumbled church ","button lion", /*name2: "lion",*/ "use", "~This is the prize you received when you selflessly faced the beast.~", 10,false),
            new Target("Ruins of a crumbled church ","cloth button", /*name2: "button",*/ "use", "This is not the right place to combine this. You should wait until you get back.", 10,false),
            ...
            new Target("Foggy void","ahead", "go", "Thick fog envelops you and your sister as you continue forward, but the environment around you doesn't change a bit. Which way now? Ahead, left or right?", 10,false),
            new Target("Foggy void","right", "go", "Although you realize you've taken some steps, it looks like you haven't moved a bit. Which way now? Ahead, left or right?", 10,false),
            new Target("Foggy void","left", "go", "Carefully, you move to the left with your sister. For a moment, you think the fog is lifting, when it thickens again. Was it your imagination or are you possibly on the right path? Which way now? Ahead, left or right?", 10,true),
            //second movement in fog
            new Target("Foggy void II","left", "go", "Left seems to have worked once before. But your hope slowly dissipates when you notice that the fog doesn't change a bit. Which way now? Ahead, left or right?", 10,false),
            new Target("Foggy void II","right", "go", "You decide to turn a little to the right. Everything looks the same. Which way now? Ahead, left or right?", 10,false),
            new Target("Foggy void II","ahead", "go", "You walk slowly and hold your breath after a few steps. A soft ringing reaches your ears. It sounds like a small bell. Pure and bright, even if very quiet. Which way now? Ahead, left or right?", 10,true),
            //third movement in fog
            new Target("Foggy void III","ahead", "go", "Disoriented, you stumble around in the void. No matter how much you walk, it always looks the same. Which way now? Ahead, left or right?", 10,false),
            new Target("Foggy void III","right", "go", "Still nothing but dense fog. Slowly you are getting desperate. Which way now? Ahead, left or right?", 10,false),
            new Target("Foggy void III","left", "go", "You're getting impatient. There must be an exit somewhere. Your steps become faster. Looking down, you can't see your feet. In the distance, you imagine a small light on the ground. Is it your imagination? It becomes clearer and clearer the closer you get. You notice how you almost start running and you have to be careful not to lose your sister behind you. One more step. Solid ground under your feet. One more step. Solid ground under your feet. One more step. Emptiness. You can't react as fast as you fall. Small pebbles accompany your fall and you also hear your sister scream as you fall together. The impact is strangely gentle, although you can feel stony ground beneath you. As you blink and try to stand up, you notice that the fog has completely disappeared. All you see now is the vastness of a huge cave. In the center of the cave, illuminated by a bluish light, rises a statue of a large cat. In some places it is broken, but its individual pieces still float as if held by magic where they were once assembled.", 10,true),
