...
public class data {
    ...
    public static Target[] DATA={
            ...
            new Target("Cage","piece of wire","cage", "use", "After fiddling around for a little you manage to unlock your cage.", 10,true),
            ...
            new Target("Ruins of a crumbled church ","button","","use", "The button falls down. It echoes unreal loud in the chapel. You bend down and pick up the dirty button. It goes back into your pocket.", 10,false),
            new Target("Ruins of a crumbled church ","button","lion","use", "~This is the prize you received when you selflessly faced the beast.~", 10,false),
            new Target("Ruins of a crumbled church ","cloth","button", "use", "This is not the right place to combine this. You should wait until you get back.", 10,false),
