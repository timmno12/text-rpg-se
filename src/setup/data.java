...
public class data {
    public static Item[] items = {
            ...
            new Item("button", "abc", 0, 0),
            new Item("cloth", "abc",0,0)
    ...
    public static Target[] DATA={
            ...
            new Target("Storage Room","location", "", "look","This is definitely a storage room. Lots of shelves filled with gruesome things you don’t really want to look at closely. The door seems like the only way out.", 10,false),
            ...
            new Target("Eerie Crypt (left room)", "location","", "look", "You almost slip as you take your first steps. The ground is slippery and it makes a sound as if you were walking through honey. Your feet are wet and with every step you feel the water coming out of the mossy ground. It is very dark. Glowing torches light the room to the bare minimum. You shiver as the humidity reaches your skin. As far as you can see, the room is almost completely empty. You see a small sphere on a stone pedestal(pedestal) in the center.", 10, false),
